 ...
 */
final class Version20251017154132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, titre VARCHAR(100) NOT NULL, contenu LONGTEXT NOT NULL, media_url VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, INDEX IDX_23A0E6667B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
