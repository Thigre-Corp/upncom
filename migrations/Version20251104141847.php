 ...
 */
final class Version20251104141847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, image_org VARCHAR(255) NOT NULL, image_mod VARCHAR(255) DEFAULT NULL, alt_text VARCHAR(255) DEFAULT NULL, mask_svg VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
